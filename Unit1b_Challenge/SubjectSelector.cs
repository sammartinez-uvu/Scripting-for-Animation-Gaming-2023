/// This code is desinged to grade and assignment as well as describe possible subjects to persue
using System;
					
public class ExamGrader{
	public SubjectStates subjectStates;
	public void Main() {
		...
		*/
		...
		subjectStates = new SubjectStates();
		//change the end with either Math, English, or Art to define which subject they should persue
		subjectStates.currentState = SubjectStates.States.Art;
		subjectStates.CheckState();
	}
} 

//Code designed to give subject ideas for a student to focus on
public class SubjectStates {
	...
	public States currentState = States.Math;
	
	public void CheckState () {
		switch (currentState) {
			case States.Math:
				Console.WriteLine("Math is a great subject! Perhaps persue a Science or a Coding Degree");
				break;
			case States.English:
				Console.WriteLine("English is a flexable degree!  Perhaps look into a Law or Grant Writing Career");
				break;
			case States.Art:
				Console.WriteLine("Art is diverse! Some options include, dance, painting, drama, ect.");
				break;
		}
	}
}